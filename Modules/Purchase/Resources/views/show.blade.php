            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap align-items-center">
                        <div>
                            Nomor Referensi: <strong>{{ $purchase->reference }}</strong>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-sm-4 mb-3 mb-md-0">
                                <h5 class="mb-2 border-bottom pb-2">Nama Perusahaan:</h5>
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                <h5 class="mb-2 border-bottom pb-2">Nama Supplier:</h5>
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                ...
                                <div>Kode Faktur: <strong>NMG/{{ $purchase->reference }}</strong></div>
